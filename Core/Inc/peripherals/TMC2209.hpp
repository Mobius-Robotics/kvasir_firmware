...
public:
    ...
    enum SerialAddress {
        SERIAL_ADDRESS_0 = 0, SERIAL_ADDRESS_1 = 1, SERIAL_ADDRESS_2 = 2, SERIAL_ADDRESS_3 = 3,
    };
    ...
    void setup(UART_HandleTypeDef *huart, SerialAddress serial_address = SERIAL_ADDRESS_0);
    ...
    void setHardwareEnablePin(GPIO_TypeDef *port, uint16_t pin);
    void enable();
    void disable();
    ...
    // range 0-100
    void setAllCurrentValues(uint8_t run_current_percent, uint8_t hold_current_percent,
...
private:
    ...
    GPIO_TypeDef *hardware_enable_port_;
    uint16_t hardware_enable_pin_;

    void initialize(UART_HandleTypeDef *huart, SerialAddress serial_address = SERIAL_ADDRESS_0);
